...
class DefaultDeviceFarmUploadArtifactsHandlerTest : DescribeSpec({
    ...
    describe("When creating AWS device farm upload") {
        describe("It should return the created AWS Upload as a right") {
            //GIVEN
        ...
        describe("Project ARN is mandatory, a left should be returned if not provided") {
            //WHEN
            val response = DefaultDeviceFarmUploadArtifactsHandler(dfClient, httpClient).createUpload(
                "",
                commonUploadType,
        ...
        describe("Artifact name is mandatory, a left should be returned if not provided") {
            //WHEN
            val response = DefaultDeviceFarmUploadArtifactsHandler(dfClient, httpClient).createUpload(
                projectArn,
                commonUploadType,
    ...
    describe("When uploading artifact to S3") {
        //GIVEN
        ...
        describe("It should return a right when upload result has OK status") {
            //WHEN
            val response =
        ...
        describe("It should return a left when upload result has not OK status") {
            //GIVEN
    ...
    describe("When fetching an AWS device farm upload") {
        describe("It should return the upload as a right") {
            //GIVEN
            val expectedUpload = Upload
                .builder()
                .arn(uploadARN)
        ...
        describe("It should return an error as a left if upload ARN is empty") {
            //WHEN
